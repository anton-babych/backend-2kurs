...
export abstract class ItemService {
  ...
  data: BehaviorSubject<ShortItemModel[]> = new BehaviorSubject<ShortItemModel[]>([]);
  ...
  updateById<Type extends ShortItemModel>(item: ShortItemModel){
    this.data.next(
      this.data.value.map((a: ShortItemModel) =>
        a.id === item.id ? item : a
      )
    );
  ...
  create<Type extends ShortItemModel>(item: ShortItemModel){
  ...
  delete<Type extends ShortItemModel>(item: ShortItemModel){
